...
namespace alc
{
  ...
  class App 
  {
    public:
      ...
      /**
       * @brief Initialise all hardware and subsystems.
       * @return true on success.
       */
      bool Init();
      
      /**
       * @brief Main run loop - handles wake event then enters System OFF.
       */
      void Run();
    ...
    private:
      ...
      /**
       * @brief Identify what woke the device from System OFF.
       */
      ...
      Adxl367 m_motion;
      MqttClient m_mqtt;
      Npm1300 m_pmic;  // Pointer - initialised from device tree.
